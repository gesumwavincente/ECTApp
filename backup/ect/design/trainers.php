    ...
    <div class="form-popup more_form_popup">
        <h2>Add Trainer:</h2>
            <form action="" method="POST" class="form-container">
                  ...
                  <button type="submit" name="submit" id="btn" class="btn">Add Trainer</button>
          ...
          <div class="form-popup more_form_popup1" id="updateForm">
                <h2>Update Trainer:</h2>
                    <form action="" method="POST" class="form-container">
                          ...
                          <input type="text" name="phone_no" placeholder="Phone Number"><br>
                          <input type="email" name="email" placeholder="Email"><br>
                          <button type="submit" name="submit" id="btn" class="btn" onclick="closeForm()">Update Trainer</button>
