 ...
 <thead>            
              ...
              <?php
                ...
                <tr>
                    ...
                    <td><a href="roster.php?<?php echo $row['training_id']; ?>"><?php echo $row['training_id']; ?></a></option>
                    </td>
                    <td>
                          ...
                          <span style="font-size: 20px; margin-left:10px"><a onclick='dell()' href="clientele.php?delete=<?php echo $row['id']; ?>"><i style=" color: red;"  class="fas fa-trash-alt"></i></a></span>
                    </td>
                </tr> 
                <?php endwhile; ?> 
            </table>
